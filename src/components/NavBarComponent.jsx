      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="gap-4  flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <button
              type="button"
              className=" text-white   focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-70"
            >
              <FaLanguage className="text-2xl font-bold text-black" />
            </button>
